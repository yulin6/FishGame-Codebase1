 ...
 * the entire game, and the game phase will be changed to moving when no more penguins should be placed, or it will be
 * changed to over when there is no more possible move for any of the penguins, any players who cheat or did not
 * respond in 15 seconds will be removed from the game state and be recorded in the GameReport. Finally, it will
 * output the game report.
 *
