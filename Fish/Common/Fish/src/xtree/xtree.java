...
import static models.FishTreeNode.getPenguinsOfSameColor;
import static models.FishTreeNode.getPositionsOfTiles;
...
//    currentPlayer = fishState.getPlayersSortedByAgeAscend().get(currentPlayerIndex);
    ...
    ArrayList<Penguin> penguinsOfTheSameColor = getPenguinsOfSameColor(fishState);
    penguinsOfTheSameColor.sort((p1, p2) -> Integer.valueOf(p1.getXPos() + p1.getYPos())
        .compareTo(p2.getXPos() + p2.getYPos()));
